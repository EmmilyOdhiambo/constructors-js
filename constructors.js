...
class Rental {
    ...
    calculateRentalDuration() {
      ...
      const differentDays = Math.round(Math.abs((startDate - endDate) / oneDay));
  ...
  const rental = new Rental(car, "John Kamau", "2023-10-05", "2023-15-05");
...
const question = new Question("How many counties are in kenya?", ["forty", "fifty", "forty seven", "sixty"], "forty seven");
const myAnswer = "forty seven";
const isCorrect = question.checkAnswer(myAnswer);
...
class Quiz{
    ...
    submitAnswer(myAnswer) {
        ...
        if (currentQuestion.checkAnswer(myAnswer)) {
          this.score++;
        }
    }
}
const quiz1 = new Quiz();
const ques1 = new Question("How many counties are in kenya?", ["forty", "fifty", "forty seven", "sixty"], "forty seven");
const ques2 = new Question("Who is the president of Kenya?", ["Raila", "Ruto", "Karua", "Uhuru"], "Ruto");
quiz1.addQuestion(ques1);
quiz1.addQuestion(ques2);

quiz1.submitAnswer("forty seven");
quiz1.nextQuestion();
